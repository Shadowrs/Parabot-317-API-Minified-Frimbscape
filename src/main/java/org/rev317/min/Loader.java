...
public class Loader extends ServerProvider {
    ...
    public Applet fetchApplet() {
        try {
            ...
            final RefClass config = new RefClass(classLoader.loadClass("com/arlania/Configuration"));
            double clientversion = config.getField("CLIENT_VER").asDouble();
            System.out.println("Frimbscape client version: "+clientversion);
            ...
            final RefClass sign = new RefClass(classLoader.loadClass("com/arlania/signlink"));
            ...
            client.getField("instance", "Lcom/arlania/Client;").set(clientInstance.getInstance());

            String host = config.getField("HOST").asString();
            sign.getMethod("startpriv", new Class[] {InetAddress.class}).invoke((InetAddress)InetAddress.getByName(host));
